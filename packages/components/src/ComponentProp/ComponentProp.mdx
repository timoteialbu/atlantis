...
name: ComponentProp
menu: Components
route: /components/component-prop
showDirectoryLink: true
---

import { Playground, Props } from "docz";
import { ComponentProp, CorrectChild } from ".";

# Component Prop

```ts
import { ComponentProp } from "@jobber/components/ComponentProp";
```

<Playground>
  <ComponentProp thing={<CorrectChild>Correct</CorrectChild>} />
  <ComponentProp thing={<div>Wrong</div>} />
</Playground>
...
The `<ComponentProp>` will... _Add a brief description of the component_
